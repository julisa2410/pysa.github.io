...
<head>
    ...
    <script type="text/javascript" src="../upload/funciones.js"></script>
...
<body id="body">    
    ...
    <div class="menu_side" id="menu__side">
        ...
        <div class="options_menu">
            ...
            <a href="exportacion.php" class="select">
                <div class="option">
...
<main>
    ...
    <h3>Guarda pedimentos de exportacion:  </h3><br><br>    
    <div class="col-md-5 col-md-offset-2">
            <input type="file" name="file" id="file" class="form-control">
        </div>
        <div class="col-md-5" >
            <button  class="btn btn-success" id="aceptar" >
            <a href="../upload/exportacion.php"> <font COLOR="white">Aceptar</font> </a>
            </button>
        </div>
    </div><br> <br> <br>
